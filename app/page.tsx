...
const projects = [
  ...
  {
    index: "24",
    title: "Taş 101 — Gerçek Oyun Masası",
    kicker: "Web Oyunu / Oyun Tasarımı / Etkileşimli Deneyim",
    description:
      "Dört kişilik klasik 101 deneyimini; oyun salonları, misafir başlangıç, canlı masa arayüzü, puan ve seri takibi, kurallar ile oyun içi ipuçlarıyla birleştiren oynanabilir web oyunu.",
    href: "https://selinturkmen1184-web.github.io/tas-101/",
    preview: "tas101",
  ...
  {
    index: "26",
    title: "AKA Endüstriyel — Akıllı Yedek Parça Kataloğu",
    kicker: "B2B Katalog / Akıllı Arama / Endüstriyel Web",
    description:
      "Endüstriyel mutfak ve bulaşık makinesi ekipmanları için 700 parçalık kataloğu; ürün kodu araması, kategori filtreleri, fotoğrafla tespit ve model uyum desteğiyle birleştiren dijital ürün deneyimi.",
    href: "https://selinturkmen1184-web.github.io/aka-endustriyel-demo/#parca-ara",
    preview: "aka",
  ...
  {
    index: "30",
    title: "İlbeyli Elektrik — Elektrik & Güvenlik Sistemleri",
    kicker: "Yerel Hizmet / Aydınlatma / Güvenlik",
    description:
      "Elektrik tesisatı ve tamiratı, avize ve LED aydınlatma, kamera ve diafon sistemleri ile mağaza ürünlerini; hizmet keşfi, gerçek mekân görselleri ve hızlı telefon/WhatsApp iletişimiyle buluşturan kurumsal web deneyimi.",
    href: "https://selinturkmen1184-web.github.io/ilbeyli-elektrik/",
    preview: "ilbeyli",
    className: "project-card project-card--full project-card--ilbeyli",
  },
];
    ...
    <main>
      ...
      <section className="work" id="isler" aria-labelledby="work-title" data-nav-section>
        <div className="section-heading reveal" data-reveal>
          <div>
            <p className="section-index">30 seçili proje · 02 TÜBİTAK çalışması</p>
        ...
        <div className="proof-grid reveal" data-reveal aria-label="Portfolyo özeti">
          <article>
            <strong data-count="30" data-pad="2">30</strong>
